...
const quizzes = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: 'Które zwierzę jest symbolizowane przez znak zodiaku Strzelec?',
        answers: ['Koń', 'Lew', 'Struś', 'Łabędź'],
        correct: 'Struś'
      },
      {
        question: 'Które państwo posiada najwięcej ludności na świecie?',
        answers: ['Chiny', 'Indie', 'Stany Zjednoczone', 'Rosja'],
        correct: 'Chiny'
      },
      {
        question: 'Kto był autorem "Zapisków z podróży"?',
        answers: ['Jules Verne', 'Mark Twain', 'Charles Dickens', 'Homer'],
        correct: 'Mark Twain'
      },
      {
        question: 'Które zwierzę jest najszybsze na świecie?',
        answers: ['Gepard', 'Szympans', 'Orzeł', 'Foka'],
        correct: 'Gepard'
      },
      {
        question: 'Które morze leży pomiędzy Azją a Europą?',
        answers: ['Morze Śródziemne', 'Morze Czarne', 'Morze Północne', 'Morze Bałtyckie'],
        correct: 'Morze Czarne'
      },
      {
        question: 'Kto odkrył Amerykę w 1492 roku?',
        answers: ['Christopher Columbus', 'Vasco da Gama', 'Marco Polo', 'Ferdinand Magellan'],
        correct: 'Christopher Columbus'
      },
      {
        question: 'Które państwo jest najmniejsze na świecie?',
        answers: ['Monako', 'Watykan', 'San Marino', 'Liechtenstein'],
        correct: 'Watykan'
      },
      {
        question: 'W którym roku miała miejsce Rewolucja Francuska?',
        answers: ['1776', '1789', '1848', '1917'],
        correct: '1789'
      },
      {
        question: 'Która planeta jest najzimniejsza w Układzie Słonecznym?',
        answers: ['Mars', 'Uran', 'Jowisz', 'Neptun'],
        correct: 'Neptun'
      },
      {
        question: 'Kto był autorem "Romeo i Julia"?',
        answers: ['William Shakespeare', 'Jane Austen', 'Charles Dickens', 'Fyodor Dostoevsky'],
        correct: 'William Shakespeare'
      },
      {
        question: 'Które zwierzę jest symbolem Australii?',
        answers: ['Kangur', 'Koala', 'Emu', 'Wombat'],
        correct: 'Kangur'
      },
      {
        question: 'Które państwo posiada najwięcej wysp na świecie?',
        answers: ['Indonezja', 'Filipiny', 'Japonia', 'Nowa Zelandia'],
        correct: 'Szwecja'
      },
      {
        question: 'Ile wynosi pierwiastek kwadratowy z liczby 81?',
        answers: ['7', '8', '9', '10'],
        correct: '9'
      },
      {
        question: 'Który z elementów chemicznych jest gazem szlachetnym?',
        answers: ['Hel', 'Azot', 'Tlen', 'Wodór'],
        correct: 'Hel'
      },
      {
        question: 'Kto był prezydentem Stanów Zjednoczonych podczas II wojny światowej?',
        answers: ['Franklin D. Roosevelt', 'Harry S. Truman', 'Dwight D. Eisenhower', 'John F. Kennedy'],
        correct: 'Franklin D. Roosevelt'
      },
      {
        question: 'Które państwo jest największym eksporterem ropy naftowej na świecie?',
        answers: ['Arabia Saudyjska', 'Rosja', 'Stany Zjednoczone', 'Kanada'],
        correct: 'Arabia Saudyjska'
      },
      {
        question: 'W którym roku miała miejsce bitwa pod Waterloo?',
        answers: ['1805', '1812', '1815', '1820'],
        correct: '1815'
      },
      {
