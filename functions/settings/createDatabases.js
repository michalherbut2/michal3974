...
module.exports = async client => {
  ...
  const createTimeoutTable    = "CREATE TABLE IF NOT EXISTS timeout     (id    INTEGER PRIMARY KEY AUTOINCREMENT, target_id TEXT, executor_id TEXT, reason TEXT, duration TEXT, action TEXT, timestamp INTEGER)"
